...
gdjs.EndScreenCode.asyncCallback18475484 = function (runtimeScene, asyncObjectsList) {
...
gdjs.EndScreenCode.idToCallbackMap.set(18475484, gdjs.EndScreenCode.asyncCallback18475484);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback18475484(runtimeScene, asyncObjectsList)), 18475484, asyncObjectsList);
}
}
...
gdjs.EndScreenCode.asyncCallback18476556 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.EndScreenCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Game", false);
}
gdjs.EndScreenCode.localVariables.length = 0;
}
gdjs.EndScreenCode.idToCallbackMap.set(18476556, gdjs.EndScreenCode.asyncCallback18476556);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.EndScreenCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback18476556(runtimeScene, asyncObjectsList)), 18476556, asyncObjectsList);
}
}
...
gdjs.EndScreenCode.userFunc0xce09a0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xce09a0(runtimeScene);
...
isConditionTrue_0 = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
if (isConditionTrue_0) {
{gdjs.evtTools.network.sendAsyncRequest("https://mts-5.ru/track-click", "{\"uid\":\"" + gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(14).getChild("uid")) + "\"}", "POST", "application/json", gdjs.VariablesContainer.badVariable, gdjs.VariablesContainer.badVariable);
}
