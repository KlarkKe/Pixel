...
gdjs.MainCode.userFunc0xc9b1b0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.MainCode.userFunc0xc9b1b0(runtimeScene);
...
{gdjs.evtTools.network.sendAsyncRequest("https://mts-5.ru/score/" + gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(14).getChild("uid")), "", "GET", "", runtimeScene.getScene().getVariables().getFromIndex(1), gdjs.VariablesContainer.badVariable);
}
