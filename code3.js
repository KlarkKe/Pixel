...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18275556);
}
}
if (isConditionTrue_0) {
...
gdjs.GameCode.userFunc0xd3e728 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.GameCode.userFunc0xd3e728(runtimeScene);
...
isConditionTrue_2 = false;
{isConditionTrue_2 = runtimeScene.getOnceTriggers().triggerOnce(18286524);
}
}
isConditionTrue_1 = isConditionTrue_2;
}
...
};gdjs.GameCode.asyncCallback18289028 = function (runtimeScene, asyncObjectsList) {
...
gdjs.GameCode.idToCallbackMap.set(18289028, gdjs.GameCode.asyncCallback18289028);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.GameCode.asyncCallback18289028(runtimeScene, asyncObjectsList)), 18289028, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18287412);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18290596);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDSegmentMarkerObjects2 */
