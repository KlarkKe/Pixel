...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18434428);
}
}
if (isConditionTrue_0) {
...
gdjs.GameCode.userFunc0xc8f378 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.GameCode.userFunc0xc8f378(runtimeScene);
...
isConditionTrue_2 = false;
{isConditionTrue_2 = runtimeScene.getOnceTriggers().triggerOnce(18445396);
}
}
isConditionTrue_1 = isConditionTrue_2;
}
...
};gdjs.GameCode.asyncCallback18446836 = function (runtimeScene, asyncObjectsList) {
...
gdjs.GameCode.idToCallbackMap.set(18446836, gdjs.GameCode.asyncCallback18446836);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.GameCode.asyncCallback18446836(runtimeScene, asyncObjectsList)), 18446836, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18446052);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18448748);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDSegmentMarkerObjects2 */
