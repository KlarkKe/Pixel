...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15233388);
}
}
if (isConditionTrue_0) {
...
gdjs.GameCode.userFunc0x1028228 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.GameCode.userFunc0x1028228(runtimeScene);
...
isConditionTrue_2 = false;
{isConditionTrue_2 = runtimeScene.getOnceTriggers().triggerOnce(15244356);
}
}
isConditionTrue_1 = isConditionTrue_2;
}
...
};gdjs.GameCode.asyncCallback15246860 = function (runtimeScene, asyncObjectsList) {
...
gdjs.GameCode.idToCallbackMap.set(15246860, gdjs.GameCode.asyncCallback15246860);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.GameCode.asyncCallback15246860(runtimeScene, asyncObjectsList)), 15246860, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15245244);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15248428);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDSegmentMarkerObjects2 */
...
{for(var i = 0, len = gdjs.GameCode.GDShape1Objects4.length ;i < len;++i) {
    gdjs.GameCode.GDShape1Objects4[i].deleteFromScene(runtimeScene);
}
for(var i = 0, len = gdjs.GameCode.GDShape4Objects4.length ;i < len;++i) {
    gdjs.GameCode.GDShape4Objects4[i].deleteFromScene(runtimeScene);
}
for(var i = 0, len = gdjs.GameCode.GDShape2Objects4.length ;i < len;++i) {
    gdjs.GameCode.GDShape2Objects4[i].deleteFromScene(runtimeScene);
}
for(var i = 0, len = gdjs.GameCode.GDShape5Objects4.length ;i < len;++i) {
    gdjs.GameCode.GDShape5Objects4[i].deleteFromScene(runtimeScene);
}
for(var i = 0, len = gdjs.GameCode.GDShape6Objects4.length ;i < len;++i) {
    gdjs.GameCode.GDShape6Objects4[i].deleteFromScene(runtimeScene);
}
for(var i = 0, len = gdjs.GameCode.GDShape3Objects4.length ;i < len;++i) {
    gdjs.GameCode.GDShape3Objects4[i].deleteFromScene(runtimeScene);
}
}
}
